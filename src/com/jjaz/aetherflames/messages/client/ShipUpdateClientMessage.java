...
public class ShipUpdateClientMessage extends ClientMessage implements AetherFlamesConstants {
	 ...
	 * C'tor
	 */
	public ShipUpdateClientMessage() {
		// intentionally empty
	}
	 ...
	 */
	public ShipUpdateClientMessage(final int sID, final int health,
	...
	public short getFlag() {
		return FLAG_MESSAGE_CLIENT_SHIP_UPDATE;
	}
